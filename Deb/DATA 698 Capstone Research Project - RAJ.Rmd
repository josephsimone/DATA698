...
### Employment in New York from Select Industry
...
# Employment vs CPI in NY - by Industry
...
ggplot(ALL_NY[,c(2,3,5,9)], mapping= aes(y= log(`Number of jobs`), x=Year,color= Description, group = Description)) + geom_smooth() + theme_classic()
```
...
test_model(model_pls,ALL_NY_train)
