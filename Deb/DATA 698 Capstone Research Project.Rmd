...
```{r load-files, include=TRUE, eval=TRUE, message=FALSE, warning=FALSE, echo=FALSE, results='hide'}
...
```{r show-raw-data, include=TRUE, eval=TRUE, message=FALSE, warning=FALSE, echo=TRUE, results='show'}
...
```{r load_files, include=TRUE, eval=TRUE, message=FALSE, warning=FALSE, echo=FALSE, results='show'}
tbl_with_sources <- tbl_with_sources %>%
                      mutate(industry = case_when(
                                                  str_contains(filename, "mfg") ~ "Manufacturing",
                                                  str_contains(filename, "manufacturing") ~ "Manufacturing",
                                                  str_contains(filename, "electric_power") ~ "Utilities",
                                                  str_contains(filename, "transportation") ~ "Transportation and warehousing",
                                                  TRUE                      ~ NA_character_
                                                  )
                             )
