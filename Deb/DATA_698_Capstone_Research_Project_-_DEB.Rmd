...
```{r}
cpi_emp_data_USFoodBeverage_NY %>% 
    select(c("Year","Sector"= "Description","No_Jobs","cpi_value")) %>%   
...
cpi_emp_data_USFoodBeverage_NY %>% 
    select(c("Year","Sector"= "Description","No_Jobs")) %>% 
...
ALL_NY$No_Jobs = as.numeric(ALL_NY$No_Jobs)
#plot_histogram(ALL_NY, ggtheme=theme_light())
#plot_correlation(ALL_NY[,c(2,5,9)])

ggplot(ALL_NY[,c("Year","Description","No_Jobs","cpi_value")], 
